...
Node.prototype.close = function(removed) {
    //console.logger(this.type,this.id,removed);
    var promises = [];
    var node = this;
...
function log_helper(self, level, msg) {
    ...
    try {
        if(self instanceof Node && self._flow) {
            ...
            //Set info to "Node object is not a node-red Node" to point out the `Node type` problem in logger
