...
class Subflow extends Flow {
    ...
    constructor(parent,globalFlow,subflowDef,subflowInstance) {
        // console.logger("CREATE SUBFLOW",subflowDef.id,subflowInstance.id,"alias?",subflowInstance._alias);
        // console.logger("SubflowInstance\n"+JSON.stringify(subflowInstance," ",2));
        // console.logger("SubflowDef\n"+JSON.stringify(subflowDef," ",2));
    ...
    start(diff) {
        ...
        // console.logger("Node.context",this.type,"id:",this._alias||this.id,"z:",this.z)
...
function createNodeInSubflow(subflowInstanceId, def) {
    ...
    // console.logger("Create Node In subflow",node._alias, "--->",nid, "(",node.type,")")
