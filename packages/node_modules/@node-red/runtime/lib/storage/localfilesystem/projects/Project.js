...
// console.logger(globalProjectSettings)
    var projectSettings = {};
...
Project.prototype.update = async function (user, data) {
    ...
    if (data.credentialSecret && data.credentialSecret !== this.credentialSecret) {
        ...
        // console.logger("updating credentialSecret");
        // console.logger("request:");
        // console.logger(JSON.stringify(data,"",4));
        // console.logger(" this.credentialSecret",this.credentialSecret);
        // console.logger(" this.info", this.info);
...
Project.prototype.getFlowFile = function() {
    // console.logger("Project.getFlowFile = ",this.paths.flowFile);
...
Project.prototype.getCredentialsFile = function() {
    // console.logger("Project.getCredentialsFile = ",this.paths.credentialsFile);
