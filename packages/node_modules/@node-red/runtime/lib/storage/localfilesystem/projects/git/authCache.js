...
module.exports = {
    ...
    set: function(project,remote,user,auth) {
         // console.logger("AuthCache.set",remote,user,auth);
        authCache[project] = authCache[project]||{};
        authCache[project][remote] = authCache[project][remote]||{};
        authCache[project][remote][user] = auth;
        // console.logger(JSON.stringify(authCache,'',4));
    },
    get: function(project,remote,user) {
        // console.logger("AuthCache.get",remote,user,authCache[project]&&authCache[project][remote]&&authCache[project][remote][user]);
