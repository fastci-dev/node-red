...
var api = module.exports = {
    ...
    * @param {Object} opts.req - the request to logger (optional)
        ...
        return new Promise(function(resolve,reject) {
            ...
            if (ctx) {
                if (key) {
                    ...
                    //             if (!errorReported) {
                    //                 errorReported = true;
                    //                 runtime.logger.audit({event: "context.delete",scope:scope,id:id,store:store,key:key,error:"unexpected_error"});
                    //                 var err = new Error();
                    //                 err.code = "unexpected_error";
                    //                 err.status = 400;
                    //                 return reject(err);
                    ...
                    //         if (c === 0) {
                    //             if (!errorReported) {
                    //                 runtime.logger.audit({event: "context.get",scope:scope,id:id,store:store,key:key});
                    //                 resolve(result);
                    //             }
                    //         }
                    //     });
