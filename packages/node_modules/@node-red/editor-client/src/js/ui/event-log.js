...
RED.eventLog = (function() {
    ...
    var template = '<script type="text/x-red" data-template-name="_eventLog"><div class="form-row node-text-editor-row"><div style="height: 100%;min-height: 150px;" class="node-text-editor" id="red-ui-event-logger-editor"></div></div></script>';
    ...
    return {
        init: function() {
            ...
            RED.actions.add("core:show-event-logger",RED.eventLog.show);
        },
        show: function() {
            if (shown) {
                return;
