...
RED.view = (function() {
    ...
    function canvasMouseMove() {
        ...
        //console.logger(d3.mouse(this),container.offsetWidth,container.offsetHeight,container.scrollLeft,container.scrollTop);
    ...
    function portMouseUp(d,portType,portIndex,evt) {
        ...
        if (mouse_mode == RED.state.JOINING || mouse_mode == RED.state.QUICK_JOINING) {
            ...
            if (addedLinks.length > 0 || removedLinks.length > 0 || modifiedNodes.length > 0) {
                // console.logger(addedLinks);
                // console.logger(removedLinks);
                // console.logger(modifiedNodes);
                var historyEvent;
    ...
    function nodeMouseDown(d) {
        ...
        if (!d.selected && d.g /*&& !RED.nodes.group(d.g).selected*/) {
            ...
            //         d.selected = true;
            //         console.logger(d.id,"Setting selected")
            //         d.gSelected = true;
            //     }
            // } else
            if (d3.event.shiftKey) {
            ...
            node.each(function(d,i) {
                ...
                if (d.dirty) {
                    ...
                    if (mouse_mode != RED.state.MOVING_ACTIVE) {
                        ...
                        //             } catch(err) {
                        //                 console.logger("Definition error: "+d.type+".badge",err);
                        //                 return "";
                        //             }
                        //         } else {
                        //             return d._def.badge;
