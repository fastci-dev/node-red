RED.sidebar.info.outliner = (function() {
        ...
        if (parent !== existingParent) {
            ...
            if (parentItem.children.length === 0) {
                if (parentItem.config) {
                    ...
                    // console.logger("Removing",n.type,"from",parentItem.parent.id||parentItem.parent.parent.id)
    ...
    function createFlowConfigNode(parent,type) {
        // console.logger("createFlowConfig",parent,type,configNodeTypes[parent]);
        if (empties[parent]) {
            empties[parent].treeList.remove();
            delete empties[parent];
        }
        ...
        if (!configNodeTypes[parent].types[type]) {
            ...
            // console.logger("CREATED", parent,type)
        }
    }
