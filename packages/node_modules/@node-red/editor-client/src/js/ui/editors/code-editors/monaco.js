...
RED.editor.codeEditor.monaco = (function() {
    ...
    function init(options) {
        ...
        //Handles orphaned models.go
        //ensure loaded models.go that are not explicitly destroyed by a call to .destroy() are disposed
        RED.events.on("editor:close",function() {
            let models = window.monaco ? monaco.editor.getModels() : null;
            if(models && models.length) {
                console.warn("Cleaning up monaco models.go left behind. Any node that calls createEditor() should call .destroy().")
        ...
        function setupJS(_monaco) {
            var createJSSnippets = function(range) {
                return [
                    ...
                    createMonacoCompletionItem("node.logger", 'node.logger(${1:"info"});','Write an info message to the console (not sent to sidebar)',range),
    ...
    function create(options) {
        ...
        //as models.go are signleton, consts and let are avialable to other javascript instances
